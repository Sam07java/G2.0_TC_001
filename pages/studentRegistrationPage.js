exports.studeregistrationPage = class studeregistrationPage {
    constructor(page) {
        ...
        this.successMessageElement = 'Registration Successful!'
    }

    // ✅ Branch Name
    async enter_the_BranchName(branchName) {
        console.log(`➡️ Entering Branch Name: ${branchName}`);
    ...
    async enter_the_FullName(fullName) {
        console.log(`➡️ Entering Full Name: ${fullName}`);
    ...
    async enter_the_AddmisionNumber(admissionNumber) {
        console.log(`➡️ Entering Admission Number: ${admissionNumber}`);
    ...
    async enter_the_DOB(dob) {
        console.log(`➡️ Entering Date Of Birth: ${dob}`);
    ...
    async select_class(cla) {
        console.log(`➡️ Selecting class: ${cla}`);
    ...
    async select_section(section) {
        console.log(`➡️ Selecting section: ${section}`);
    ...
    async click_on_sameAsAbove_Checkbox() {
        console.log(`➡️ Clicking on Same As Above Checkbox`);
    ...
    async enter_the_FatherName(fatherName) {
        console.log(`➡️ Entering Father Name: ${fatherName}`);
    ...
    async enter_the_FatherContactNumber(fatherContactNumber) {
        console.log(`➡️ Entering Father Contact Number: ${fatherContactNumber}`);
    ...
    async enter_the_MotherName(motherName) {
        console.log(`➡️ Entering Mother Name: ${motherName}`);
    ...
    async enter_the_MotherContactNumber(motherContactNumber) {
        console.log(`➡️ Entering Mother Contact Number: ${motherContactNumber}`);
    ...
    async enter_the_City(city) {
        console.log(`➡️ Entering City: ${city}`);
    ...
    async click_on_Complete_Registration_Button() {
        console.log(`➡️ Clicking on Complete Registration Button`);
    ...
    async verify_Student_Creation_Success() {
        const successMessage = await this.page.getByText(this.successMessageElement).isVisible();
